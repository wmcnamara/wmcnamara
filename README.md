...
- I am familiar with Vulkan and HLSL.
 ...
 ## Notable Projects
  ...
  - [APOD Changer](https://github.com/wmcnamara/apodchanger), a simple to use program that automatically downloads and updates the users desktop background with the NASA Astronomy Picture of the Day. It is used by dozens every single day and is available on the Windows platform.
